window.SEARCH_INDEX = [
  ...
  },
  {
    ...
    category: "Lawsuit Topic",
    text: "environmental contamination lawsuits polluted water industrial waste toxic emissions chemical releases groundwater contamination community exposure landfills superfund pollution claims"
  },
  {
    title: "Air Pollution Lawsuits",
    url: "air-pollution-lawsuits",
    category: "Lawsuit Topic",
    text: "air pollution lawsuits toxic emissions industrial releases smoke dust airborne contamination smog particulate matter refinery emissions community air quality claims"
  },
  {
    title: "Toxic Water Contamination Lawsuits",
    url: "toxic-water-contamination-lawsuits",
    category: "Lawsuit Topic",
    text: "toxic water contamination lawsuits polluted drinking water pfas industrial chemicals solvents military bases camp lejeune private wells public water systems groundwater community exposure"
  },
  {
    ...
    category: "Legal Guide",
    text: "has anyone been part of a pfas water contamination lawsuit pfas lawsuit examples public pfas cases settlements 3m dupont afff mdl who has sued over pfas water contamination case patterns"
  },
  {
    title: "PFAS Drinking Water Contamination by State",
    url: "pfas-drinking-water-contamination-by-state",
    category: "Legal Guide",
    text: "pfas drinking water contamination by state pfas in my state pfas contamination map state level pfas data public water systems testing results ucmr epa data pfas hot spots state by state"
  },
  {
    title: "PFAS Consumer Product Lawsuits",
    url: "pfas-consumer-product-lawsuits",
    category: "Lawsuit Topic",
    text: "pfas consumer product lawsuits pfas in products food packaging nonstick cookware treated fabrics water resistant clothing pfas class action false advertising consumer protection forever chemicals everyday products"
  },
  {
    title: "PFAS Cosmetics Lawsuits",
    url: "pfas-cosmetics-lawsuits",
    category: "Lawsuit Topic",
    text: "pfas cosmetics lawsuits pfas in makeup pfas in beauty products waterproof mascara foundation lipstick personal care products forever chemicals consumer class action false advertising labeling"
  },
  {
    title: "PFAS Sewage Sludge Farm Lawsuits and the EPA",
    url: "pfas-sewage-sludge-farm-lawsuit-epa",
    category: "News and Analysis",
    text: "pfas sewage sludge farm lawsuit biosolids farmland contamination epa risk assessment pfas in fertilizer agricultural land crops livestock farm contamination claims maine texas forever chemicals soil"
  },
  {
    title: "EPA PFAS Rule Analysis",
    url: "epa-pfas-rule-analysis",
    category: "News and Analysis",
    text: "epa pfas rule analysis pfas drinking water standards maximum contaminant levels mcl pfoa pfos regulation safe drinking water act compliance deadlines regulated entities water utilities litigation impact"
  },
  {
    title: "Consumer Product Lawsuits",
    url: "consumer-product-lawsuits",
    category: "Lawsuit Topic",
    text: "consumer product lawsuits personal care products baby products medications food products contamination defective products warning failures consumer safety claims"
  },
  {
    title: "Kidney Cancer Lawsuits",
    url: "kidney-cancer-lawsuits",
    category: "Lawsuit Topic",
    text: "kidney cancer lawsuits renal cell carcinoma pfas contaminated water chemical exposure toxic exposure solvents trichloroethylene kidney cancer claims"
  },
  {
    title: "California Lawsuits",
    url: "california-lawsuits",
    category: "Lawsuit Topic",
    text: "california lawsuits california toxic exposure california dangerous products california environmental contamination california consumer safety state focused lawsuit topics proposition 65"
  },
  {
    title: "California Environmental Contamination Lawsuits",
    url: "california-environmental-contamination-lawsuits",
    category: "Lawsuit Topic",
    text: "california environmental contamination lawsuits california polluted water california groundwater contamination industrial pollution refineries pfas central valley los angeles bay area community exposure claims"
  },
  {
    title: "Product Liability Lawsuits",
    url: "product-liability-lawsuits",
    category: "Legal Guide",
    text: "product liability lawsuits defective products design defect manufacturing defect failure to warn strict liability negligence dangerous products how product liability claims work"
  },
  {
    title: "Toxic Tort Basics",
    url: "toxic-tort-basics",
    category: "Legal Guide",
    text: "toxic tort basics what is a toxic tort chemical exposure claims causation exposure evidence latency toxic tort vs personal injury contamination cases how toxic tort claims work"
  },
  {
    title: "Mass Torts",
    url: "mass-torts",
    category: "Legal Guide",
    text: "mass torts what is a mass tort mass tort vs class action coordinated litigation product cases exposure cases how mass tort litigation works individual claims"
  },
  {
    title: "How Mass Tort Cases Are Structured and Resolved",
    url: "how-mass-torts-work",
    category: "Legal Guide",
    text: "how mass torts work mass tort structure mdl multidistrict litigation not a class action bellwether trials global settlement individual settlement how mass tort cases resolve census registry"
  },
  {
    title: "Current Mass Tort Cases",
    url: "current-mass-tort-cases",
    category: "Lawsuit Topic",
    text: "current mass tort cases active mass torts toxic exposure pesticides contaminated water consumer products product liability ongoing litigation browse mass torts"
  },
  {
    title: "MDL Basics",
    url: "mdl-basics",
    category: "Legal Guide",
    text: "mdl basics what is an mdl multidistrict litigation consolidated cases jpml transferee court bellwether trials pretrial proceedings remand how mdls work federal court"
  },
  {
    title: "Bellwether Trials",
    url: "bellwether-trials",
    category: "Legal Guide",
    text: "bellwether trials what is a bellwether trial test trials mdl representative cases settlement value verdicts how bellwether trials shape mass tort litigation"
  },
  {
    title: "Class Actions",
    url: "class-action",
    category: "Legal Guide",
    text: "class actions what is a class action class member class certification opt out rights rule 23 class action vs mass tort settlement notice how class actions work"
  },
  {
    title: "Personal Injury Lawsuits",
    url: "personal-injury",
    category: "Legal Guide",
    text: "personal injury lawsuits injury claims damages negligence compensation pain and suffering medical expenses lost wages how personal injury cases work civil claims"
  },
  {
    title: "Where Does My Lawsuit Stand? Litigation Status Tracker",
    url: "where-does-my-lawsuit-stand",
    category: "Legal Guide",
    text: "where does my lawsuit stand litigation status tracker mass tort status what phase is my lawsuit in case milestones mdl status roundup paraquat afff talc hair relaxer depo provera updates"
  },
  {
  ...
  },
  {
    ...
    category: "Lawsuit Topic",
    text: "transvaginal mesh lawsuits pelvic mesh vaginal mesh pelvic organ prolapse stress urinary incontinence mesh erosion chronic pain revision surgery boston scientific ethicon bard mesh injuries"
  },
  {
    title: "Transvaginal Mesh Litigation Update",
    url: "transvaginal-mesh-litigation-update",
    category: "News and Analysis",
    text: "transvaginal mesh litigation update pelvic mesh update public developments settlements verdicts fda actions mesh litigation news product claims"
  },
  {
    ...
    category: "Legal Guide",
    text: "transvaginal mesh manufacturers product identifiers pelvic mesh brands boston scientific ethicon gynecare bard avaulta coloplast how to identify which mesh product implant card medical records"
  },
  {
    title: "Meta New Mexico Child Safety Verdict",
    url: "meta-new-mexico-child-safety-verdict",
    category: "News and Analysis",
    text: "meta new mexico child safety verdict meta lawsuit verdict instagram facebook child safety platform liability state enforcement attorney general social media litigation minors online safety"
  },
  {
    title: "Social Media Addiction Lawsuit Update",
    url: "social-media-addiction-lawsuit-update",
    category: "News and Analysis",
    text: "social media addiction lawsuit update public developments instagram tiktok snapchat youtube meta mdl jccp school districts state attorneys general platform litigation news"
  },
  {
    title: "Consumer Safety Lawsuit Developments",
    url: "consumer-safety-lawsuit-developments",
    category: "News and Analysis",
    text: "consumer safety lawsuit developments product safety consumer claims litigation trends recalls regulatory actions broader consumer protection developments"
  },
  {
  ...
  },
  {
    ...
    category: "News and Analysis",
    text: "house v ncaa settlement update house settlement news college athletes revenue sharing nil back pay claims process distribution college sports settlement developments"
  },
  {
